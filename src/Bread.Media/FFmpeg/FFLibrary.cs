namespace FFmpeg.AutoGen
{
	...
	internal class FFLibrary
	{
        ...
        /// Gets the AVCodec library.
        /// </summary>
        public static FFLibrary LibAVCodec { get; } = new FFLibrary(Names.AVCodec, 59, 37);

        /// <summary>
        /// Gets the AVFormat library.
        /// </summary>
        public static FFLibrary LibAVFormat { get; } = new FFLibrary(Names.AVFormat, 59, 27);

        /// <summary>
        /// Gets the AVUtil library.
        /// </summary>
        public static FFLibrary LibAVUtil { get; } = new FFLibrary(Names.AVUtil, 57, 28);

        /// <summary>
        /// Gets the SW Resample library.
        /// </summary>
        public static FFLibrary LibSWResample { get; } = new FFLibrary(Names.SWResample, 4, 7);

        /// <summary>
        /// Gets the SWScale library.
        /// </summary>
        public static FFLibrary LibSWScale { get; } = new FFLibrary(Names.SWScale, 6, 7);

        /// <summary>
        /// Gets the AVDevice library.
        /// </summary>
        public static FFLibrary LibAVDevice { get; } = new FFLibrary(Names.AVDevice, 59, 7);

        /// <summary>
        /// Gets the Post-processing library.
        /// </summary>
        public static FFLibrary LibPostProc { get; } = new FFLibrary(Names.PostProc, 56, 6);

        /// <summary>
        /// Gets the AVFilter library.
        /// </summary>
        public static FFLibrary LibAVFilter { get; } = new FFLibrary(Names.AVFilter, 8, 44);
